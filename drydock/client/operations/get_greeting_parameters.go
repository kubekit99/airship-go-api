...
// WithName adds the name to the get greeting params
func (o *GetGreetingParams) WithName(name *string) *GetGreetingParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the get greeting params
func (o *GetGreetingParams) SetName(name *string) {
	o.Name = name
}
