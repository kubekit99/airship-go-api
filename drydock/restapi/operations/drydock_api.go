...
// NewDrydockAPI creates a new Drydock instance
func NewDrydockAPI(spec *loads.Document) *DrydockAPI {
	return &DrydockAPI{
...
/*DrydockAPI the drydock API */
type DrydockAPI struct {
	spec            *loads.Document
...
func (o *DrydockAPI) SetDefaultProduces(mediaType string) {
	o.defaultProduces = mediaType
}

// SetDefaultConsumes returns the default consumes media type
func (o *DrydockAPI) SetDefaultConsumes(mediaType string) {
	o.defaultConsumes = mediaType
}

// SetSpec sets a spec that will be served for the clients.
func (o *DrydockAPI) SetSpec(spec *loads.Document) {
	o.spec = spec
}

// DefaultProduces returns the default produces media type
func (o *DrydockAPI) DefaultProduces() string {
	return o.defaultProduces
}

// DefaultConsumes returns the default consumes media type
func (o *DrydockAPI) DefaultConsumes() string {
	return o.defaultConsumes
}

// Formats returns the registered string formats
func (o *DrydockAPI) Formats() strfmt.Registry {
	return o.formats
}

// RegisterFormat registers a custom format validator
func (o *DrydockAPI) RegisterFormat(name string, format strfmt.Format, validator strfmt.Validator) {
	o.formats.Add(name, format, validator)
}

// Validate validates the registrations in the DrydockAPI
func (o *DrydockAPI) Validate() error {
...
func (o *DrydockAPI) ServeErrorFor(operationID string) func(http.ResponseWriter, *http.Request, error) {
	return o.ServeError
}

// AuthenticatorsFor gets the authenticators for the specified security schemes
func (o *DrydockAPI) AuthenticatorsFor(schemes map[string]spec.SecurityScheme) map[string]runtime.Authenticator {
...
func (o *DrydockAPI) Authorizer() runtime.Authorizer {
...
func (o *DrydockAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
...
func (o *DrydockAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
...
func (o *DrydockAPI) HandlerFor(method, path string) (http.Handler, bool) {
	if o.handlers == nil {
		return nil, false
	}
...
// Context returns the middleware context for the drydock API
func (o *DrydockAPI) Context() *middleware.Context {
	if o.context == nil {
...
func (o *DrydockAPI) initHandlerCache() {
...
func (o *DrydockAPI) Serve(builder middleware.Builder) http.Handler {
	o.Init()
...
func (o *DrydockAPI) RegisterConsumer(mediaType string, consumer runtime.Consumer) {
	o.customConsumers[mediaType] = consumer
}

// RegisterProducer allows you to add (or override) a producer for a media type.
func (o *DrydockAPI) RegisterProducer(mediaType string, producer runtime.Producer) {
