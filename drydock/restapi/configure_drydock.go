...
//go:generate swagger generate server --target ../../drydock --name Drydock --spec ../swagger/swagger.yml

func configureFlags(api *operations.DrydockAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.DrydockAPI) http.Handler {
