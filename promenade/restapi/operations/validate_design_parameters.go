...
// ValidateDesignParams contains all the bound params for the validate design operation
// typically these are obtained from a http.Request
//
// swagger:parameters validateDesign
...
//
// To ensure default values, the struct must have been initialized with NewValidateDesignParams() beforehand.
func (o *ValidateDesignParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *ValidateDesignParams) bindXAuthToken(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
