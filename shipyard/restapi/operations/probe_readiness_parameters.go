...
// ProbeReadinessParams contains all the bound params for the probe readiness operation
...
func (o *ProbeReadinessParams) bindXAuthToken(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
