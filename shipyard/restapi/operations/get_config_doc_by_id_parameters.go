...
// GetConfigDocByIDParams contains all the bound params for the get config doc by Id operation
// typically these are obtained from a http.Request
//
// swagger:parameters getConfigDocById
...
//
// To ensure default values, the struct must have been initialized with NewGetConfigDocByIDParams() beforehand.
func (o *GetConfigDocByIDParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
...
func (o *GetConfigDocByIDParams) bindXAuthToken(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *GetConfigDocByIDParams) bindCollectionID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
