...
//go:generate swagger generate server --target ../../shipyard --name Shipyard --spec ../swagger/swagger.yml

func configureFlags(api *operations.ShipyardAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.ShipyardAPI) http.Handler {
