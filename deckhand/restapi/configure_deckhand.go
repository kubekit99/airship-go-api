...
//go:generate swagger generate server --target ../../deckhand --name Deckhand --spec ../swagger/swagger.yml

func configureFlags(api *operations.DeckhandAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.DeckhandAPI) http.Handler {
