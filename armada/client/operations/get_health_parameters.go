...
// WithXAuthToken adds the xAuthToken to the get health params
func (o *GetHealthParams) WithXAuthToken(xAuthToken *string) *GetHealthParams {
	o.SetXAuthToken(xAuthToken)
	return o
}

// SetXAuthToken adds the xAuthToken to the get health params
func (o *GetHealthParams) SetXAuthToken(xAuthToken *string) {
