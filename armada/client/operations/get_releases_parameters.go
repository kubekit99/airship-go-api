...
// WithXAuthToken adds the xAuthToken to the get releases params
func (o *GetReleasesParams) WithXAuthToken(xAuthToken *string) *GetReleasesParams {
	o.SetXAuthToken(xAuthToken)
	return o
}

// SetXAuthToken adds the xAuthToken to the get releases params
func (o *GetReleasesParams) SetXAuthToken(xAuthToken *string) {
	o.XAuthToken = xAuthToken
}

// WithTillerHost adds the tillerHost to the get releases params
func (o *GetReleasesParams) WithTillerHost(tillerHost *string) *GetReleasesParams {
	o.SetTillerHost(tillerHost)
	return o
}

// SetTillerHost adds the tillerHost to the get releases params
func (o *GetReleasesParams) SetTillerHost(tillerHost *string) {
	o.TillerHost = tillerHost
}

// WithTillerNamespace adds the tillerNamespace to the get releases params
func (o *GetReleasesParams) WithTillerNamespace(tillerNamespace *string) *GetReleasesParams {
	o.SetTillerNamespace(tillerNamespace)
	return o
}

// SetTillerNamespace adds the tillerNamespace to the get releases params
func (o *GetReleasesParams) SetTillerNamespace(tillerNamespace *string) {
	o.TillerNamespace = tillerNamespace
}

// WithTillerPort adds the tillerPort to the get releases params
func (o *GetReleasesParams) WithTillerPort(tillerPort *int64) *GetReleasesParams {
	o.SetTillerPort(tillerPort)
	return o
}

// SetTillerPort adds the tillerPort to the get releases params
func (o *GetReleasesParams) SetTillerPort(tillerPort *int64) {
